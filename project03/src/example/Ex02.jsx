...
const Ex02 = () => {
    ...
    2. public 폴더
        ...
        - public 폴더응 서버와 통신이 가능하다
        - 장점 : 외부파일처럼 유연하게 파일 사용이 가능 , import필요X
  ...
  return (
    <div>
        ...
        {/*2. public 폴더 */}
        {/*<img width='300px' src="http://localhost:3000/img/img2.jpg"></img>*/}
        <p className='text'>
            
            <span onClick={()=>{handleLike()}}>{num2}</span>
            <span>좋아요 {num1} 개</span>
