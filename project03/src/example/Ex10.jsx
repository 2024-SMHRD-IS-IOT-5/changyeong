...
const Ex10 = () => {
    ...
    const addNewTodo = ()=>{
        ...
        // 스프레드 문법(...)
        // 기좁 배열이 있다면 배열을 유지시키고 그 뒤로 내용ㅇ을 추가한다
        // [...기본배열,추가할내용]
        setTodos([...todos,
            {text : newTodo,
            completed : false,
    ...
    // 1. ListItem의 DELETE 버튼을 눌렀을 때, deleteTodo 함수를 실행시킨다. 
    //      (context, 익명함수, 매개변수에 내가 누른 그 할일의 고유num 를 보낸다.)
    // 2. Ex10.jsx deleteTodo 함수로 와서 매개변수 안에 숫자를 console창에 확인해본다.
    // 3. filter 함수를 사용해서 배열 내의 아이템의 고유 숫자가, 내가 받아온 숫자가 
    ...
    // 2. Ex10.jsx 로 와서 매개변수 안에 숫자 확인 
    // 3. find 함수를 사용해서 배열 내에 내가 가져온 숫자와 동일한 todo를 찾는다. 
    // 4. 찾은 그 todo의 completed를 반대로 
    // 5. 바뀐 todo를 다시 재 세팅 
  ...
  return (
    <TodoContext.Provider 
                    value ={{todos, setTodos, newTodo, setNewTodo, 
                            addNewTodo, deleteTodo, toggleTodo}}>
